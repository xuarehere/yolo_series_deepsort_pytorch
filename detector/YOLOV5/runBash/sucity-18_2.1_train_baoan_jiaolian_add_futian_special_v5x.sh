cd ..
python train.py   --img-size 640  --batch-size 32 --epochs 80 --data sucity-18-2_train_baoan_jiaolian_add_futian_special.yaml  --weights /workspace/models/yolov5/v4.0/yolov5x.pt    --device 0,1  --sync-bn  --epochs_save 5
