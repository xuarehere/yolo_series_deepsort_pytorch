    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if rank in [-1, 0]:
            ...
            if save:
                ...
                if (epoch) % opt.epochs_save == 0:
                    # save_file = wdir / "epoch_" + str(epoch) + ".pth"
                    epoch_str = "epoch_" + str(epoch) + ".pth"
                    save_file = os.path.join(wdir, epoch_str)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--epochs_save', type=int, default=20, help='number of save epoch')
