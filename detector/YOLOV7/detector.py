...
from detector.YOLOV7.models.experimental import attempt_load
from detector.YOLOV7.utils.general import check_img_size, non_max_suppression, apply_classifier, scale_coords, xyxy2xywh, \
