...
from detector.YOLOR.utils.google_utils import attempt_load
from detector.YOLOR.utils.datasets import LoadStreams, LoadImages
from detector.YOLOR.utils.general import (
    check_img_size, non_max_suppression, apply_classifier, scale_coords, xyxy2xywh, strip_optimizer)
from detector.YOLOR.utils.plots import plot_one_box
from detector.YOLOR.utils.torch_utils import select_device, load_classifier, time_synchronized

from detector.YOLOR.models.models import *
from detector.YOLOR.utils.datasets import *
from detector.YOLOR.utils.general import *
...
class YOLOr(object):
    ...
    score_thresh=0.0, conf_thresh=0.25, nms_thresh=0.45,
                 is_xywh=True, use_cuda=True, imgsz=640, half=False, dataset_config="detector/YOLOR/data/coco.yaml"):    
        # net definition
        self.half = half
