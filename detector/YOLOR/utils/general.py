...
try:
    ...
    from detector.YOLOR.utils.google_utils import gsutil_getsize
    from detector.YOLOR.utils.metrics import fitness, fitness_p, fitness_r, fitness_ap50, fitness_ap, fitness_f   
    from detector.YOLOR.utils.torch_utils import init_torch_seeds
