try:
    ...
    from detector.YOLOR.utils.google_utils import *
    from detector.YOLOR.utils.layers import *
    from detector.YOLOR.utils.parse_config import *
    from detector.YOLOR.utils import torch_utils
ONNX_EXPORT = False
