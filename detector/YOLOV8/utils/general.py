...
try:
    ...
    from detector.YOLOV8.utils import TryExcept, emojis
    from detector.YOLOV8.utils.downloads import gsutil_getsize
    from detector.YOLOV8.utils.metrics import box_iou, fitness
